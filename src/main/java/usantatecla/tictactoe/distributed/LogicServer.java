...
public class LogicServer extends Logic {
	...
	public void createDispatchers(DispatcherPrototype dispatcherPrototype) {
		...
		dispatcherPrototype.add(FrameType.TICTACTOE, new TicTactToeDispatcher(this.playController));
		...
		dispatcherPrototype.add(FrameType.RESULT, new ResultDispatcher(this.resultController));
		dispatcherPrototype.add(FrameType.OTHER_VALUE_TURN, new OtherValueTurnDispatcher(this.resultController));
	}
