= Master Mind. Solución 5.2. *modelViewPresenter.presentationModel*
...
tictactoe.TicTacToe --> tictactoe.controllers.ResumeController
...
tictactoe.views.View *-down-> tictactoe.controllers.ResumeController
...
class  tictactoe.utils.YesNoDialog{
...
tictactoe.utils.WithConsoleView <|-down- tictactoe.utils.YesNoDialog
