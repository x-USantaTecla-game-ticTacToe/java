...
tictactoe.controllers.AcceptorController *-down-> tictactoe.distributed.dispatchers.TCPIP
...
tictactoe.controllers.Logic *-down-> tictactoe.distributed.dispatchers.TCPIP
...
tictactoe.distributed.dispatchers.ResumeDispatcher ..> tictactoe.controllers.ResultController
