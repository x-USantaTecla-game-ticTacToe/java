...
tictactoe.views.View *-down-> tictactoe.controllers.Controller
...
tictactoe.views.console.ConsoleView ..> tictactoe.controllers.ResultController
...
- [red line-through]#_**DRY**: en las clases de vistas que asume el flujo de control y se repite en mastermind.views.console.ProposalView y mastermind.views.graphics.GameView_#
- [red]#_**Principio de Sustitución de Liskov**: las vistas preguntan por el tipo de controlador polimórfico_#
