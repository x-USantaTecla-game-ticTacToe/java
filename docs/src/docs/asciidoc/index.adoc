...
tictactoe .down.> tictactoe.controllers.implementation
...
[plantuml,tictactoeVersion10,svg]
....
...
[plantuml,tictactoeViewsVersion10,svg]
...
[plantuml,tictactoeModelsVersion10,svg]
...
[plantuml,tictactoeControllersVersion10,svg]
...
+ {abstract} getErrorsPutCoordinate(Coordinate): Error
+ {abstract} getErrorsMoveOriginCoordinate(Coordinate): Error
+ {abstract} getErrorsMoveTargetCoordinate(Coordinate, Coordinate): Error
...
+ {abstract} moveTokenPlayerFromTurn(Coordinate, Coordinate): void
