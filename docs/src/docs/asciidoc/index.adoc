= Master Mind. Solución 14.6. *mvp.pm.withoutPrototype*
...
[plantuml,arquitecturaVersion13,svg]
....
...
[plantuml,tictactoeVersion13,svg]
....
...
class  tictactoe.TicTacToeStandaloneFile{
# createDAO(): SessionImplementationFile
+ {static} main(String[]): void
}
tictactoe.TicTacToeStandalone <|-down- tictactoe.TicTacToeStandaloneFile

class  tictactoe.TicTacToeStandaloneDB{
# createLogic(): SessionImplementationDAO
+ {static} main(String[]): void
}
tictactoe.TicTacToeStandalone <|-down- tictactoe.TicTacToeStandaloneDB

....

=== Paquete _tictactoe.views_

[plantuml,tictactoeViewsVersion13,svg]
...
[plantuml,tictactoeModelsVersion13,svg]
...
[plantuml,tictactoeControllersVersion13,svg]
...
class  tictactoe.distributed.TicTacToeServerDB{
+ createDAO(): SessionImplementationDAO
+ {static} main(String[]): void
}
tictactoe.distributed.TicTacToeServer <|-down- tictactoe.distributed.TicTacToeServerDB

class  tictactoe.distributed.TicTacToeServerFile{
+ createDAO(): SessionImplementationDAO
+ {static} main(String[]): void
}
tictactoe.distributed.TicTacToeServer <|-down- tictactoe.distributed.TicTacToeServerFile
