...
utils.WithConsoleModel <|-down- tictactoe.views.console.BoardView

class  tictactoe.views.console.ChoosePlayerView{
~ readPlayers(): void
}
utils.WithConsoleModel <|-down- tictactoe.views.console.ChoosePlayerView
...
utils.WithConsoleModel <|-down- tictactoe.views.console.CoordinateView
